...
knitr::opts_chunk$set(
    echo = FALSE,        # Ne montre pas le code source
    message = FALSE,     # Masque les messages de la console
    warning = FALSE      # Masque les avertissements (warnings)
)
```
...
```{r manually_cleaned_data_loading}
